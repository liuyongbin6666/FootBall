 ...
 * 英雄碰撞
*/
@ccclass('HeroCollision')
export class HeroCollision extends Component {
    ...
    private initCollision() {
        if (this.collider) {
            ...
            // console.log('初始化英雄碰撞！',this.collider);
        }
    }
        ...
        private onEndContact(selfCollider: Collider2D, otherCollider: Collider2D) {
            //console.log('英雄碰撞结束！',selfCollider.group,otherCollider.group);
