...
export class SHA1 {
     ...
     * They take string arguments and return either hex or base-64 encoded strings
       */
    public hex_sha1(s: string): string { return this.binb2hex(this.core_sha1(this.str2binb(s), s.length * this.chrsz)); }
    private b64_sha1(s: string): string { return this.binb2b64(this.core_sha1(this.str2binb(s), s.length * this.chrsz)); }
    private str_sha1(s: string): string { return this.binb2str(this.core_sha1(this.str2binb(s), s.length * this.chrsz)); }
    private hex_hmac_sha1(key: string, data: string): string { return this.binb2hex(this.core_hmac_sha1(key, data)); }
    private b64_hmac_sha1(key: string, data: string): string { return this.binb2b64(this.core_hmac_sha1(key, data)); }
    private str_hmac_sha1(key: string, data: string): string { return this.binb2str(this.core_hmac_sha1(key, data)); }
